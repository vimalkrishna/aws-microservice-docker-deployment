<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %>
  ...
  setInterval(() => {
    ...
    <!-- https://blog.afi.io/blog/plan-a-route-with-multiple-stops-using-the-routes-api/   -->
    <script async defer
      src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCcNtMqgI8b0xxYNAJYv2T80m6NCrL-21g&callback=initMap">
      </script>
  </body>
