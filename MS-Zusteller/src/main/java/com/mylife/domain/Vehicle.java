...
public class Vehicle {
	...
	public String toString() {
		return "Vehicle [name=" + name + ", odometer=" + odometer + ", status=" + status + ", lat=" + lat
				+ ", longitude=" + longitude + ", lastRecordedPosition=" + lastRecordedPosition + ", currentDriver="
				+ currentDriver + "]";
	}
